...
const productSlugs: Record<string, keyof typeof import('@/lib/translations').tr.productsPage.cementSilos> = {
  'horizontal-cement-silo': 'horizontal',
  'cs-50-cement-silo': 'cs50',
  'cs-75-cement-silo': 'cs75',
  'cs-100-cement-silo': 'cs100',
  'cs-200-bolted-cement-silo': 'cs200',
  'cs-300-bolted-cement-silo': 'cs300',
  'cs-500-bolted-cement-silo': 'cs500',
  'cs-1000-bolted-cement-silo': 'cs1000',
  'cs-2000-bolted-cement-silo': 'cs2000',
  'cs-3000-bolted-cement-silo': 'cs3000',
};
      ...
      <section className="bg-gray-100 py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/urunler/cement-silos" className="hover:text-blue-600">{t.productsDropdown.cementSilos}</Link>
            <span>/</span>
