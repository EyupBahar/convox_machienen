...
const productSlugs: Record<string, keyof typeof import('@/lib/translations').tr.productsPage.mobileConcrete> = {
  'mobile-30': 'mobile30',
  'mobile-60': 'mobile60',
  'mobile-100': 'mobile100',
  'mobile-120': 'mobile120',
  'mobicom-30': 'mobicom30',
  'mobicom-45': 'mobicom45',
  'prefeeding-conveyor': 'prefeedingConveyor',
};
...
export default function ProductDetail({ params }: { params: Promise<{ slug: string }> }) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/urunler/mobil-beton" className="text-blue-600 hover:underline">
  ...
  const product = t.productsPage.mobileConcrete[productKey] as {
    name: string;
    description: string;
  };
      ...
      <section className="bg-gray-100 py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/urunler/mobil-beton" className="hover:text-blue-600">{t.productsDropdown.mobileConcrete}</Link>
            <span>/</span>
