...
const productSlugs: Record<string, keyof typeof import('@/lib/translations').tr.productsPage.asphaltPlant> = {
  'stationary-asphalt-plant': 'stationary',
  'mobile-asphalt-plant-batch': 'mobileBatch',
};
      ...
      <section className="bg-gray-100 py-4">
        <div className="container mx-auto px-4">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/urunler/asfalt" className="hover:text-blue-600">{t.productsDropdown.asphaltPlant}</Link>
            <span>/</span>
